...
class FedAVGTrainer(object):
    ...
    def __init__(self, client_index, train_local,
        ...
        self.local_sample_number = self.client_index
    ...
    def test_on_the_server(self, test_global, device, args):
        print('Server: testing')
        self.trainer.test(test_global, device, args)
        return True